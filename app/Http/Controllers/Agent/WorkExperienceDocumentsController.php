...
use App\Models\StudentWorkExperiencePicture;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\File;

class WorkExperienceDocumentsController extends Controller
{
    ...
    {
        // get all pictures
        $pictures = StudentWorkExperiencePicture::where('student_id', Auth::user()->id)->get();
        $pictures->map(function ($picture) {
            ...
            $picture['deleteUrl'] = route('workExperienceDocuments.destroy', $picture->id);
            return $picture;
        });
    ...
    public function store(Request $request)
    {
        ...
        foreach ($files as $file) {
            ...
            if ($file->completed) {
                ...
                // save data
                $picture = StudentWorkExperiencePicture::create([
                ...
                $data[] = [
                    ...
                    'deleteType' => 'DELETE',
                    'deleteUrl' => route('workExperienceDocuments.destroy', $picture->id),
                ];
    ...
    public function destroy(Request $picture)
    {
        ...
        DB::table('student_work_experience_pictures')->where('id', $id[4])->delete();
