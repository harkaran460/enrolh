...
use App\Models\StudentEnglishTestScorePicture;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\File;

class EnglishTestScoreDocumentsController extends Controller
{
    ...
    {
        // get all pictures
        $pictures = StudentEnglishTestScorePicture::where('student_id', Auth::user()->id)->get();
        $pictures->map(function ($picture) {
            ...
            $picture['deleteUrl'] = route('englishTestScoreDocuments.destroy', $picture->id);
            return $picture;
        });
    ...
    public function store(Request $request)
    {
        ...
        foreach ($files as $file) {
            ...
            if ($file->completed) {
                ...
                // save data
                $picture = StudentEnglishTestScorePicture::create([
                ...
                $data[] = [
                    ...
                    'deleteType' => 'DELETE',
                    'deleteUrl' => route('englishTestScoreDocuments.destroy', $picture->id),
                ];
    ...
    public function destroy(Request $picture)
    {
        ...
        DB::table('student_english_test_score_pictures')->where('id', $id[4])->delete();
