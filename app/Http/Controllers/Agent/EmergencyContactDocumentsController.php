...
use App\Models\StudentEmergencyContactPicture;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\File;

class EmergencyContactDocumentsController extends Controller
{
    ...
    {
        // get all pictures
        $pictures = StudentEmergencyContactPicture::where('student_id', Auth::user()->id)->get();
        $pictures->map(function ($picture) {
            ...
            $picture['deleteUrl'] = route('emergencyContactDocuments.destroy', $picture->id);
            return $picture;
        });
    ...
    public function store(Request $request)
    {
        ...
        foreach ($files as $file) {
            ...
            if ($file->completed) {
                ...
                // save data
                $picture = StudentEmergencyContactPicture::create([
                ...
                $data[] = [
                    ...
                    'deleteType' => 'DELETE',
                    'deleteUrl' => route('emergencyContactDocuments.destroy', $picture->id),
                ];
    ...
    public function destroy(Request $picture)
    {
        ...
        DB::table('student_emergency_contact_pictures')->where('id', $id[4])->delete();
