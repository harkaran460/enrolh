...
class StudentEducationDocumentsController extends Controller
{
    ...
    {
        // get all pictures
        $pictures = StudentEducationPicture::where('student_id', Auth::user()->id)->get();
        $pictures->map(function ($picture) {
            ...
            $picture['deleteUrl'] = route('studentEducationDocuments.destroy', $picture->id);
            return $picture;
        });
    ...
    public function store(Request $request)
    {
        ...
        foreach ($files as $file) {
            ...
            if ($file->completed) {
                ...
                // save data
                $picture = StudentEducationPicture::create([
                ...
                $data[] = [
                    ...
                    'deleteType' => 'DELETE',
                    'deleteUrl' => route('studentEducationDocuments.destroy', $picture->id),
                ];
    ...
    public function destroy(Request $picture)
    {
        ...
        DB::table('student_education_pictures')->where('id', $id[4])->delete();
