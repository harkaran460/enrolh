                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="ready-submit"
                                            @if ($astatus >= 7) checked @else '' @endif>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="submitted-school"
                                            @if ($astatus >= 8) checked @else '' @endif>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="ready-visa"
                                            @if ($astatus >= 9) checked @else '' @endif>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="ready-enroll"
                                            @if ($astatus >= 10) checked @else '' @endif>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value=""
                                            ...
                                            @if ($astatus >= 12) checked @else '' @endif>
                                                                                                                                        ...
                                                                                                                                        <?php if(!empty($image_name)) 
                                                                                                                                            {
                                                                                                                                                ...
                                                                                                                                                {  
                                                                                                                                                    ...
                                                                                                                                                    <img src="<?php echo $img_url . '/' . $student_details->app_id . '/' . $data->image_name; ?>" alt="img"
                                                                                                                                                                        width="200" id="uploaddoc<?php echo $doc_list->id; ?>">
                                                                                                                                                        <?php  
                                                                                                                                                    }
                                                                                                                                                }  
