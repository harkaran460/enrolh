        ...
        <div class="row">
            <div class="col-12 d-flex flex-row justify-content-end">
                ...
                <div class="d-flex flex-row">
                    ...
                    <button class="btn me-4 fw-normal fs-5 border rounded-pill px-3 py-1 border-primary">Apply
                        Filter</button>
                    <button class="btn me-4 fw-normal fs-5 border rounded-pill px-3 py-1 border-primary" type="button"
                    ...
                    <a class="btn me-4 fw-normal fs-5 border rounded-pill px-3 py-1 border-primary" href="#"
                        data-bs-toggle="modal" data-bs-target="#addNewStudent"><i class="fa-solid fa-plus me-2"></i>Add
                        new student</a>
                </div>
                        ...
                        <div class="modal-dialog" style="max-width: 600px;">
                            <div class="modal-content">
                                ...
                                <div class="modal-body " style="height: 600px; overflow-Y: scroll;">
                                    <p>Please provide a legitimate email address for your student that is actively
                                        monitored by them. Their country is required to forward applications to our
                                        partner schools. Note: ApplyBoard will not communicate with your student via
                                        email or other methods.</p>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3 gndr-ads">
                                        ...
                                        <div class="d-flex flex-row sg">
                                            <div class="w-100 me-3 d-flex align-items-center">
                                                <input class="mt-1 d-none" type="radio" name="select-gender"
                                                    id="radiomale" checked>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexCheckDefault">
                                            I confirm that I have received express written consent from the student whom
                                            I am creating this profile for and I can provide proof of their consent upon
                                            request. To learn more please refer to the <a href="#">Personal Data
                                                Consent</a> article.
                                        </label>
                                    </div>
                                </div>
                        ...
                        <ul class="nav nav-pills mb-3 d-flex flex-row flex-nowrap" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item w-100" role="presentation">
                                <button class="nav-link w-100" id="pills-profile-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-profile" aria-selected="false">Columns</button>
                            </li>
                        </ul>
                        <div class="tab-content" id="student-filters-tabs">
                            <div class="tab-pane fade show active aplly-filter apply_fliter_check" id="pills-home"
                                ...
                                <div class="mb-3 payment_status">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="form-check form-check-inline d-grid justify-content-end"
                                    ...
                                    <div class="mb-3 d-flex">
                                        <div class="form-check">
                                            <input class="form-check-input " type="radio" name="payment_statues"
                                ...
                                <div class="mb-3 apply_filter_application">
                                    ...
                                    <div class="mb-3 d-flex">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_accepted" id="inlineRadio1" value="option1">
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_accepted" id="inlineRadio2" value="option2">
                                        </div>
                                    ...
                                    <div class="mb-3 d-flex">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_rejected" id="inlineRadio1" value="option1">
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_rejected" id="inlineRadio2" value="option2">
                                        </div>
                                    ...
                                    <div class="mb-3 d-flex">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_canceled" id="inlineRadio1" value="option1">
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_canceled" id="inlineRadio2" value="option2">
                                        </div>
                                    ...
                                    <div class="mb-3 d-flex">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_withdrawn" id="inlineRadio1" value="option1">
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_withdrawn" id="inlineRadio2" value="option2">
                                        </div>
                                    ...
                                    <div class="mb-3 d-flex">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_refundprogress" id="inlineRadio1"
                                                value="option1">
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_refundprogress" id="inlineRadio2"
                                                value="option2">
                                        </div>
                                    ...
                                    <div class="mb-3 d-flex">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_program_closed" id="inlineRadio1"
                                                value="option1">
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_program_closed" id="inlineRadio2"
                                                value="option2">
                                        </div>
                                    ...
                                    <div class="mb-3 d-flex">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_deferralprogress" id="inlineRadio1"
                                                value="option1">
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_deferralprogress" id="inlineRadio2"
                                                value="option2">
                                        </div>
                                    ...
                                    <div class="mb-3 d-flex">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_waitlisted" id="inlineRadio1" value="option1">
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"
                                                name="appplication_status_waitlisted" id="inlineRadio2" value="option2">
                                        </div>
                                    ...
                                    <div class="mb-3 d-flex">
                                        <div class="form-check">
                                            <input class="form-check-input " type="radio"
                                                name="appplication_status_readyenroll" id="inlineRadio1"
                                                value="option1">
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input " type="radio"
                                                name="appplication_status_readyenroll" id="inlineRadio2"
                                                value="option2">
                                        </div>
                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                ...
                                <ul class="p-0 m-0 column-check">
                                    ...
                                    <li><span>Student ID</span> <input class="form-check-input" type="checkbox" value=""
                                            id="studentId"><label class="form-check-label" for="studentId">
                                    ...
                                    <li><span>First Name</span> <input class="form-check-input" type="checkbox" value=""
                                            id="fName"><label class="form-check-label" for="fName">
                                            <i class="fa-solid fa-eye"></i>
                                        </label></li>
                                    <li><span>Last Name</span> <input class="form-check-input" type="checkbox" value=""
                                            id="lName"><label class="form-check-label" for="lName">
                                            <i class="fa-solid fa-eye"></i>
                                        </label></li>
                                    <li><span>Nationality</span> <input class="form-check-input" type="checkbox"
                                            value="" id="nationlty"><label class="form-check-label" for="nationlty">
                                            <i class="fa-solid fa-eye"></i>
                                        </label></li>
                                    <li><span>Recruitment Partner</span> <input class="form-check-input" type="checkbox"
                                            value="" id="recuPart"><label class="form-check-label" for="recuPart">
                                            <i class="fa-solid fa-eye"></i>
                                        </label></li>
                                    <li><span>Recruiter Type</span> <input class="form-check-input" type="checkbox"
                                            value="" id="recuType"><label class="form-check-label" for="recuType">
                                            <i class="fa-solid fa-eye"></i>
                                        </label></li>
                                    <li><span>Education</span> <input class="form-check-input" type="checkbox" value=""
                                            id="education"><label class="form-check-label" for="education">
                                            <i class="fa-solid fa-eye"></i>
                                        </label></li>
                                    <li><span>Applications</span> <input class="form-check-input" type="checkbox"
                                            value="" id="application"><label class="form-check-label" for="application">
                                            <i class="fa-solid fa-eye"></i>
                                        </label></li>
                                    <li><span>Referral Source</span> <input class="form-check-input" type="checkbox"
                                            value="" id="referSour"><label class="form-check-label" for="referSour">
                                            <i class="fa-solid fa-eye"></i>
                                        </label></li>
                                    <li><span>Lead Status</span> <input class="form-check-input" type="checkbox"
                                            value="" id="leadStat"><label class="form-check-label" for="leadStat">
                                            <i class="fa-solid fa-eye"></i>
                                        </label></li>
                                </ul>
                            </div>
                            ...
                            <table class="table">
                                <thead>
                                    ...
                                    <form method="GET" action="/admin-application-list" id="frmApplicationFilter">
                                        <tr>
                                                        ...
                                                        <div class="two fields">
                                                            <div class="field">
                                                                ...
                                                                <div class="ui calendar" id="rangestart">
                                                                    <div class="ui input left icon">
                                                                        ...
                                                                        <input type="text" name="payment_start_date"
                                                                            placeholder="Start"
                                                            ...
                                                            <div class="field margin-10">
                                                                ...
                                                                <div class="ui calendar" id="rangeend">
                                                                    <div class="ui input left icon">
                                                                        <i class="calendar icon"></i>
                                                                        <input type="text" name="payment_end_date"
                                                                            placeholder="End"
                                                                            onchange="this.form.submit()">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="two fields">
                                                            <div class="field">
                                                                <div class="ui calendar" id="rangestart1">
                                                                    <div class="ui input left icon">
                                                                        <i class="calendar icon"></i>
                                                                        <input type="text" name="application_start_date"
                                                                            placeholder="Start"
                                                                            onchange="this.form.submit()">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="field margin-10">
                                                                <div class="ui calendar" id="rangeend1">
                                                                    <div class="ui input left icon">
                                                                        <i class="calendar icon"></i>
                                                                        <input type="text" name="application_end_date"
                                                                            placeholder="End"
                                                                            onchange="this.form.submit()">
                                                                    </div>
                                                                </div>
                                            ...
                                            <td scope="col">
                                                <div class="input-control">
                                                    <input type="text" class="form-control" name="requirement_partner"
                                                        style="width: 200px;">
                                                </div>
                                            </td>
                                            <td scope="col">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li><a class="dropdown-item"
                                                            href="/admin-application-review/{{$applicationlist->app_id}}"><i
                                                                class="bi bi-pencil"></i> View Application</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                        <td class="text-center"><a
                                                href="#">{{date('d-M-Y', strtotime($applicationlist->payment_date))}}
                                            </a></td>
                                        <td class="text-center">
                                            <a
                                                href="/admin-application-review/{{$applicationlist->app_id}}">{{$applicationlist->app_id}}</a>
                                        </td>
                                        <td class="text-center">{{$applicationlist->user_id}}</td>
                                        <td class="text-center"><span>{{$applicationlist->email}}</span></td>
                                        <td class="text-center">
                                            <span>{{date('d-M-Y', strtotime($applicationlist->created_at))}}</span></td>
                                        <td class="text-center"><span>{{$applicationlist->first_name}}</span></td>
                                        <td class="text-center"><span>{{$applicationlist->last_name}}</span></td>
                                        <td class="text-center"><a
                                                href="/agent-program-details/{{$applicationlist->pid}}"><span>{{$applicationlist->programs_name}}</span></a>
                                        </td>
                                        <td class="text-center"><a
                                                href="/agent-college-details/{{$applicationlist->cid}}"><span><img
                                                        width="20" height="20"
                                                        src="{{ url('/images/' . $applicationlist->college_logo) }}"
                                                        alt="Logo" />
                                                    {{$applicationlist->program_college_name}}</span></a></td>
                                        <td><span>{{date('d-M-Y', strtotime($applicationlist->earliest_intake_date))}}
                                            </span></td>
                                        <td class="text-center"><a href="#">{{$applicationlist->partner_email}}</a></td>


                                        <td class="text-center"><span
                                                class="{{$applicationlist->bgcolor}} px-2 py-1 rounded-pill text-white text-white">{{$applicationlist->status_name}}</span>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <span
                                                class="bg-light px-3 py-1 rounded-pill">{{$applicationlist->status_title}}</span>
                                        </td>

                                        <td class="text-center">
                                            <span class="application_view"><a
                                                    href="/admin-application-review/{{$applicationlist->app_id}}">View</a></span>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
                    ...
                    <div class="col mb-3">
                        ...
                        <div>
                            <input type="number" class="form-control" id="percentage"
                                placeholder="Enter Payment Percentage" name="percentage">
                        </div>
                    </div>

                    <div class="col mb-3">
                        <label for="fixed" class="form-label">Fixed</label>
                        <input type="number" class="form-control" id="fixed" placeholder="Enter Payment Fixed"
                            name="fixed">
                    </div>
                </div>
