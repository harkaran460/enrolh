                                                                                                                        ...
                                                                                                                        <div class="row">
                                                                                                                            ...
                                                                                                                            <div class="col-md-8">
                                                                                                                                    ...
                                                                                                                                    <?php if(!empty($image_name)) 
                                                                                                                                        {
                                                                                                                                            ...
                                                                                                                                            {  
                                                                                                                                                ...
                                                                                                                                                if($data->doc_id == $doc_list->id)
                                                                                                                                                {
                                                                                                                                                   ...
                                                                                                                                                   <div class="card">
                                                                                                                                                      <a href="<?php echo $img_url . '/' . $student_details->app_id . '/' . $data->image_name; ?>" target="_blank">
                                                                                                                                                           <img src="{{$img}}" class="card-img-top" style="max-height:150px">
                                                                                                                                                      </a>
                                                                                                                                ...
                                                                                                                                <div class="row mt-md-3">
                                                                                                                                    <div class="col-md-12">
                                                                                                                                        <?php if(!empty($image_name)) 
                                                                                                                                        {
                                                                                                                                            ...
                                                                                                                                            {  
                                                                                                                                                if($data->doc_id == $doc_list->id)
                                                                                                                                                {?>
                                                                                                                                                <div id="suceesspass_{{$doc_list->id}}"></div>
                                                                                                                                    ...
                                                                                                                                    <div style="display:none" id="disaprove_{{$doc_list->id}}">
                                                                                                                                        
                                                                                                                                        <textarea class="form-control" id="disc_{{$doc_list->id}}" name="disc"><?php if($data->backend_comment !='null'){ echo "$data->backend_comment";} ?></textarea>
                                                                                                                                        <br>
                                                                                                                                        <a href="javascript:void(0)" onclick="disaproved('{{$doc_list->id}}','{{$student_details->app_id}}');"  class="btn btn-secondary mt-2 float-end">Confirm identity</a>
                                                                                                                                ...
                                                                                                                                <div id="msgpass_{{$doc_list->id}}"></div>                                                                                                                          </div>
                                                                                                                        </div>
