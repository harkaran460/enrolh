...
<div class="page-content">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 d-flex flex-row justify-content-end">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="notice_title"
                                                id="notice_title" placeholder="Enter Notice Title">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="notice_des" id="notice_des"
                                                rows="3"></textarea>
                                            <span class="text-danger">
                                                @error('notice_des')
                                                {{$message}}
                ...
                <div class="modal fade" id="editNotice" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    ...
                    <form method="post" action="update-notice">
                        ...
                        <div class="modal-dialog" style="max-width: 600px;">
                            <div class="modal-content">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{$notice_data->notice_title}}" name="notice_title"
                                                id="notice_title" placeholder="Enter Notice Title">
                                            <span class="text-danger">
                                                @error('notice_title')
                                                {{$message}}
                                        ...
                                        <div class="form-group">
                                            <label for="notice_des">Notice Description</label>
                                            <textarea class="form-control" name="notice_des" id="notice_des"
                                                rows="3">{{$notice_data->notice_title}}</textarea>
                                            <span class="text-danger">
                                                @error('notice_des')
                                                {{$message}}
                                                @enderror
                                ...
                                <div class="modal-footer d-flex flex-row">
                                    <a href="notice-board" type="button" class="btn px-4"
                                        style="background-color: #FFE5E4;">Cancel</a>
    ...
    <div class="container-fluid pt-5">
        <div class="alert-success" role="alert">
            <center>
                <h3 style="font-size: 22px;">{{Session::get('notice_deleted')}}</h3>
            </center>
            <center>
                <h3 style="font-size: 22px;">{{Session::get('notice_submited')}}</h3>
            </center>
            <center>
                <h3 style="font-size: 22px;">{{Session::get('notice_updated')}}</h3>
            </center>
        </div>
        <h3>All Notice</h3>
        <div class="row">
            ...
            <div class="col-6">
                <div class="card m7">
                    ...
                    <div class="card-body card-body-my">
                        ...
                        <a href="?edit_notice_id={{$notice->id}}#editNotice"><i class='fas fa-edit'
                                style='font-size:20px'></i></a>
                        <a href="#" onclick="Confirm('Yes', 'Cancel', '?delete_notice_id={{$notice->id}}')"><i
                                class='fas fa-trash' style='font-size:20px'></i></a>
