...
@section('content')
    ...
    <div class="page-content college-details">
        ...
        <!--<div class="row mt-4 gallery-collage">
                <div class="col-md-5 gallery-list">
                    <a href="https://www.callcenterdialerprovider.com/applyhere/agent/assets/img/collage-photo.png">
                        <img src="https://www.callcenterdialerprovider.com/applyhere/agent/assets/img/collage-photo.png" alt="college images" class="img-fluid">
                    </a>
                </div>
                <div class="col-md-5 gallery-list">
                    <div class="row">
                ...
                <div class="col-md-12 gallery-list">
                    <div class="view-more">
                        <a class="btn btn-primary rounded-pill px-3" href="assets/img/collage-photo.png">
                            View Photos
                        </a>
                    </div>
                </div>
        ...
        <div class="row m-60" id="about_us">
            ...
            <div class="col-md-4">
                <div class="d-grid gap-2">
                    <button class="btn btn-primary fs-4"> Check Student Eligibility </button>
                </div>
                <div class="top-disciplines mt-4">
                    <h4 class="fs-3 pb-23">Top Disciplines</h4>
        ...
        <div class="row mt-5" id="admission-requirements">
                ...
                <div class="main-features-about">
                    ...
                    <div class="p-3 mt-2">
                        <div class="admission-requirements minimum-language">
                            <h2>Minimum Language Test Scores</h2>
                            <div class="row">
                                        ...
                                        <div class="card-body">
                                            <div class="accordion" id="this-program-requires">
                                                <div class="accordion-item">
                                                    ...
                                                    <hr>
                                                    <h3> {{$score->test_scores_number}}</h3>
                                                    <div id="minimum-language-featuresone"
                                                        ...
                                                        <div class="accordion-body">
                                                            <ul>
                                                                <li>
                                                                    <h5><b> Reading</b></h5>
                                                                    <h1><b> {{$score->reading}}</b></h1>
                                                                </li>
                                                                <li>
                                                                    <h5><b> Writing</b></h5>
                                                                    <h1><b> {{$score->writing}}</b></h1>
                                                                </li>
                                                                <li>
                                                                    <h5><b> Listening</b></h5>
                                                                    <h1><b> {{$score->listening}}</b></h1>
                                                                </li>
                                                                <li>
                                                                    <h5><b> Speaking</b></h5>
                                                                    <h1><b> {{$score->speaking}}</b></h1>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                    ...
                    @endif
                    @if(isset($profile_updated->id))
                    @if($profile_updated->id =='')
                    <div class="bg-white p-3 mt-3">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="panelsStayOpen-featureheadingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#panelsStayOpen-featuresOne" aria-expanded="false"
                                        aria-controls="panelsStayOpen-collapseOne">
                                        This program requires valid language test results
                                    </button>
                                </h2>
                                <div id="panelsStayOpen-featuresOne" class="accordion-collapse collapse show"
                                    aria-labelledby="panelsStayOpen-featureheadingOne">
                                    <div class="accordion-body">
                                        <p>Applicants interested in applying for direct admission, but are yet to
                                            complete an acceptable language test, can do so, but must provide valid
                                            results before receiving a final offer letter.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-4">
                <div class="program-intakes mb-md-3">
                    <h4 class="fs-3 pb-3">Program Intakes</h4>
                    <div class="bg-white p-3">
                ...
                <div class="commissions">
                    <h4 class="fs-3 pb-3">Commissions</h4>
                    <div class="bg-white p-3">
...
<div class="modal fade" id="check-student-eligibility" tabindex="-1" aria-labelledby="selectstudentLabel"
    aria-hidden="true">
