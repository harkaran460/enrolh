                                ...
                                <div class="css-1jlq0r65 css-gqqadv">
                                    ...
                                    <!--    {{ ucfirst(trans($firstcaracter)) }} </div>-->
                                     <div data-testid="student-profile-913705-initials-avatar" >
                                        <img width=40 height=40 src="https://w7.pngwing.com/pngs/481/915/png-transparent-computer-icons-user-avatar-woman-avatar-computer-business-conversation-thumbnail.png"> </div>
                                </div>
                            </div>
                            ...
                            <div class="stepwizard-row setup-panel">
                                ...
                                <div class="stepwizard-step">
                                    <a href="" class="btn btn-default" disabled="disabled">
                                        ...
                                        <?php if($studentdetails[0]->refused_visa !=1){ ?>
                                            <i class="fa-solid fa-circle-check" id="green-color"></i>
                                            <?php }else{?>
                                                <i class="fa-solid fa-circle-check" id="red-color"></i>
                                           <?php }?>
                                ...
                                <div class="col-md-12">
                                    <div>
                                        ...
                                        <a href="/student_profile_application">
                                            <button type="button" class=" float-end btn1-primary">Discourse School and
                                                Programs</button>
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <div class="row mt-md-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control datepicker_input"
                                                    ...
                                                    placeholder="" name="attended_institution_from"
                                    ...
                                    <div class="add_attended_school_row">
                                        ...
                                        <div>
                                            ...
                                            <div class="row" style="display: none1">
                                                <div class="col-md-12">
                                                    <div class=" desk-float">
                                                        <a href="javascript:;" id="cancile1" class="btn1-cancel">Cancel</a>
                                                        <a href="javascript:;" class="btn1-primary" id="show">Expand</a>
                                            ...
                                            <div class="row mt-md-3">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control datepicker_input"
                                                        ...
                                                        placeholder="" name="attended_institution_to3"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="float-end">
                                                    <a href="javascript:;" class="btn1-cancel">Cancel</a>
 ...
 <div class="box-holder p-4 mt-2" >
  ...
  <div id="indianSchoolmain">
      <div id="indianSchoolmaininner" class="mx-4">
         ...
         <h2 class="text-start pt-2 fs-3">{{ $studentdetails[0]->name_of_institution }}</h2>
         
         
          <div id="ischoolmain-First" class="d-flex justify-content-between flex-wrap pt-2">
          ...
          <div id="ischoolmain-Second" class="d-flex justify-content-between flex-wrap"> 
          ...
          <div id="ischoolmain-Three" class="d-flex justify-content-between flex-wrap">
               <div>
                                                    <svg role="img" width="24" height="24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <div id="ischoolmain-Four" class="d-flex justify-content-between flex-wrap">
               <div>
                                                    <svg role="img" width="24" height="24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                ...
                                                <div class="inSchul-right-main">
                                                     <span >
                                                        {{ date('F d, Y', strtotime($studentdetails[0]->attended_institution_from)) }} -  {{ date('F d, Y', strtotime($studentdetails[0]->attended_institution_to)) }}
                                                    </span>
                                                </div>
          </div>
          <div id="ischoolmain-Five" class="d-flex justify-content-between flex-wrap">
               <div>
                                                    <svg role="img" width="24" height="24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <div id="ischoolmain-Six" class="d-flex justify-content-between flex-wrap">
               <div>
                                                    <svg role="img" width="24" height="24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
...
<!--INDIAN SCHOOL LEARNING SECTION BY KD-->
                        ...
                        <div class="card mt-md-3 additional-qualifications">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-check form-switch">
                                            <?php if($studentdetails[0]->gre_exam_date !=''){?>
                                            <input class="form-check-input main-switch" type="checkbox"
                                                id="flexSwitchCheckDefaultexam" checked="checked">
                                             <?php }else {?>
                                                <input class="form-check-input main-switch" type="checkbox"
                                ...
                                <?php if($studentdetails[0]->gre_exam_date !=''){?> 
                                <div class="main-switch-toggle mt-md-3" style="display: block;">
                                <?php }else{?>
                                ...
                                <div class="row mt-md-3">
                                    <div class="col-md-12">
                                        <div class="form-check form-switch">
                                            <?php if($studentdetails[0]->gmat_gre_exam_date !=''){?>
                                            <input class="form-check-input main-switch2" type="checkbox"
                                                id="flexSwitchCheckDefaultgmat" checked="checked">
                                              <?php }else{?>
                                                <input class="form-check-input main-switch2" type="checkbox"
                                ...
                                <?php if($studentdetails[0]->gmat_gre_exam_date !=''){?>
                                <div class="main-switch-toggle2 mt-md-3" style="display: block;">
                                <?php }else{?>
                                 ...
                                 <?php } ?>   
                                   ...
                                   <div class="col-md-3">
                                            <div class="form-group">
                                                <label> overall in English Exam Score </label>
                                                <input type="tel" class="form-control" placeholder="Score"
                                                    value="" name="lisenting"
                                                    id="lisenting">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch">
                                            ...
                                            <input class="form-check-input main-switch3" type="checkbox"
                                                ...
                                                <?php }else{?>
                                                    <input class="form-check-input main-switch3" type="checkbox" id="flexSwitchCheckDefaultgmat1">
                                                <?php }?>
                                ...
                                <?php if($studentdetails[0]->date_of_exam !=''){?>
                                <div class="main-switch-toggle3 mt-md-3" style="display: block;" data-select2-id="209">
                                    <?php }else{?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="exam_type" id="exam_type">
                                                    @foreach ($getEnglishexamType as $type)
                                                        <option value={{ $type->id }} <?php if($studentdetails[0]->english_exam_type == $type->id ){ echo "selected";}else{echo "";}?>>{{ $type->exam_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
