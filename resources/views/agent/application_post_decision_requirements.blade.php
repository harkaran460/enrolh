                    ...
                    <ul class="steps">
                        ...
                        <li class="step step--incomplete step--active">
                            ...
                            <span class="step__label">
                                <div class="dropdown ">
                                  <button class="btn btn-light2 dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Post-Decision Requirements
                                     </button>
                                     <ul class="dropdown-menu">
                                       <li><a class="dropdown-item" href="#"><i class="bi bi-circle"></i> &nbsp; Completed By Applicant</a></li>
                                       <li><a class="dropdown-item" href="#"><i class="bi bi-circle"></i> &nbsp; Completed By ApplyBoard</a></li>
                                    <li><a class="dropdown-item" href="#"><i class="fa-solid fa-circle text-success"></i> &nbsp; Completed By School</a></li>
                                     </ul>
                                </div>
                            </span>
                        </li>
