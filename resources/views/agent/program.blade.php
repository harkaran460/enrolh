...
@section('content')
    ...
    <div class="page-content program p-15">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-3 pe-20">
                    <div>
                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item shadow mb-20">
                                <h2 class="accordion-header filtertip border-bottom" id="eligibilityheadingOne">
                                        ...
                                        <form action="agenteligibilityfilter" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="search">
                                                    ...
                                                    <input type="text" id="search-dropdwon-main" class="form-control h-42"
                                            ...
                                            <div class="form-group py-1 mb-0 pb-0">
                                            ...
                                            <div class="form-group mb-0 text-end pt-20">
                                                <button type="submit" class=" btn apply-filter-white waves-effect waves-light">Cancel</button>
                                                <button type="submit" class=" btn text-white apply-filter-primary waves-effect waves-light ms-2">APPLY FILTERS</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                    ...
                    <div class="">
                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item shadow mb-20">
                                <h2 class="accordion-header filtertip border-bottom" id="schoolfiltersheadingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                <div id="school-filters" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <form action="agentcollagefilter" method="POST">
                                            ...
                                            <div class="form-group checkbox py-1 mb-0">
                                                <div class="row">
                                                    <div class="col">
                                            ...
                                            <div class="form-group checkbox mb-0 py-1 pb-0">
                            ...
                            <div class="accordion-item shadow">
                                <h2 class="accordion-header filtertip border-bottom" id="programfiltersheadingTwo">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    ...
                                    <div class="accordion-body">
                                        <form action="agentprogramfilter" method="POST">
                                            ...
                                            <div id="slider-range"></div>
                                              <p class="pt-2">
                                              <input type="text" class="ps-0" id="amount" readonly style="border:0;">
                                            </p>
                                            </div>
                                            </div>
                                            ...
                                            <div id="slider-range1"></div>
                                              <p class="pt-2">
                                              <input type="text" class="ps-0" id="amount1" readonly style="border:0;">
                                            </p>
                                            </div>
                                            </div>
                                            <div class="form-group  checkbox pt-3 mb-0">
                ...
                <div class="col-md-9 ps-0">
                    <div class="bg-white-1 p-4 px-0 h-100">
                        
                        <div class="row pb-4 mx-0 px-4">
                            <div class="col-md-8">
                                <div class="d-flex ">
                                    <span class="search">
                                                    
                                               <input type="text" style="min-height: 36px;" class=" me-4 inp-resp"
                                    placeholder="Search Programs">
                                                    <i style="top: 28%" class=" start-0 fa fa-search"></i>
                                    ...
                                    <button class="btn btn-primary clr bt-resp text-center" style="min-height: 36px;" type="button">
                                Search </button>
                                </div>
                                
                            </div>
                            <div class="col-md-4"><ul class="d-flex float-end select-bar-program">
                            <li>
                                <form action="agentProgram" method="GET">
                                    @csrf
                                    <div class="form-group">
                                        <select class="form-select slt-resp" style="min-height: 36px;" id="sorting" name="sorting"
                        ...
                        <div class="row mx-0 mb-20" style="border-bottom: 1px solid rgb(212, 212, 212);"></div>
                        <div class="program-list px-4">
                            ...
                            <div class="tab-pane fade active show" id="programs" role="tabpanel"
                                ...
                                @if ($collages != 'not_found')
                                    @foreach ($collages as $list)
                                        <div class="main-programs-content shadow bg-white program-card">
                                            <div class="main-programs-img  shadow">
                                                <a href="/agent-college-details/{{ $list->id }}">
                                                    <img width="42" height="42" src="{{ url('/images/' . $list->college_logo) }}" alt="Logo" />
                                                </a>
                                                <div class="pt-1">
                                                    <div>
                                                        <a
                                            ...
                                            @foreach ($list->courses as $p)
                                                <div class="main-programs-img-content">
                                                    <div class="">
                                                        ...
                                                        <div class="main-programs-list gap-5">
                                                            <div class="d-flex justify-content-between gap-3 ">
                                                                <img class="rounded-circle header-profile-user" src="assetsAgent/img/dollar-circle.png" alt="Header Avatar">
                                                            <div class="css-1kos2q0 pt-1">
                                                                
                                                                <span class="pb-0">TUITION FEE</span>
                                                            ...
                                                            <div class="d-flex justify-content-between gap-3">
                                                                <img class="rounded-circle header-profile-user" src="assetsAgent/img/note-circle.png" alt="Header Avatar">
                                                            <div class="css-1kos2q0 pt-1">
                                                                <span class="pb-0">APPLICATION FEE</span>
                                                                <span>
                                                            ...
                                                            <div class="d-flex justify-content-between gap-3">
                                                                <img class="rounded-circle header-profile-user" src="assetsAgent/img/note-circle.png" alt="Header Avatar">
                                                            <div class="css-1kos2q0 pt-1">
                                                                <span class="pb-0">Commission</span>
                                                                <span>
                                                                   10%
                                                                </span>
                                                            </div>
                                        ...
                                        <div class="text-start pb-3">
                                           <a href="javascript:;" class="ms-1 ps-4 see-more"> See {{ count($list->courses) }}
                                            ...
                                            <div class="main-slide">
                                                ...
                                                @endforeach
                                                <a href="javascript:;" class="less-more ms-1 ps-4 "> See Less <i
