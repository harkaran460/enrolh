...
<div class="page-content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="review-main bg-white p-2">
                    <h3>Show Application</h3>
                    <ul>
                        <li><a href=""> Home</a></li>
                        <li><i class="fa fa-angle-right"></i></li>
                        <li><a href="recruitment_partners"> Recruitment Partners</a></li>
                        <li><i class="fa fa-angle-right"></i></li>
                        <li><a href="recruitment_partner-id"> EnrolHere</a></li>
                        <li><i class="fa fa-angle-right"></i></li>
                        ...
                        <li><i class="fa fa-angle-right"></i></li>
                        <li><a href=""> <b> [2217050] Graduate Certificate - Health Care Leadership - Canadian Context (5987) @ Sault College - Brampton</b></a></li>
                    </ul>
                    <hr>
                </div>
            </div>
                    ...
                    <ul class="steps">
                        ...
                        <li class="step step--incomplete step--active">
                            ...
                            <span class="step__label">
                                <div class="dropdown ">
                                    <button class="btn btn-light2 dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"> Prepare Application </button>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#"><i class="fa-solid fa-circle text-success"></i> &nbsp; Completed By Applicant</a></li>
                                        <li><a class="dropdown-item" href="#"><i class="bi bi-circle"></i> &nbsp; Completed By ApplyBoard</a></li>
                                        <li><a class="dropdown-item" href="#"><i class="bi bi-circle"></i> &nbsp; Completed By School</a></li>
                                    </ul>
                                </div> 
                            </span>
                        </li>
                        <li class="step step--incomplete step--inactive">
                            <span class="step__icon"></span>
                            <span class="step__label">Submission</span>
                        </li>
                        <li class="step step--incomplete step--inactive">
                            <span class="step__icon"></span>
        ...
        <div class="row mt-md-3 click-item">
            <div class="col-md-5 click-item-details">
                <div class="main-review-left">
                    <div class="main-review-icondrop d-flex justify-content-between">
                        <div class="main-review-icon1">
                            <a href="javascript:;"><i class="fa-solid fa-bars"></i></a>
                        </div>
                        <div class="drop1">
                            <select class="form-control select2" name="Other Applications">
                                <!--<option value="">No other applications</option>-->
                                <option>Yorkville University - Toronto | Bachelor of Business Administration - Project Management (3 years)</option>
                            </select>
                        </div>
                    </div>
                    <div class="css-1p7mtvv">
                        <div class="row">
                            <div class="col-4">
                               <div class="row">
                                    <div class="col-7 muiBox-img">
                                        <img src="assetsAgent/img/user.svg" class="img-fluid" alt="" />
                                    </div>
                                    <div class="col-5 css-18xhlkt">
                                ...
                                <div class="css-11bq05t">
                                    <div class="css-xdzpz9">
                                        <div class="sidebar-country">
                                            <img src="assetsAgent/img/country-logo.png" class="img-fluid" alt="">
                                       </div>
                    ...
                    <div class="add-backup-program" data-bs-toggle="modal" data-bs-target="#add_backup">
            ...
            <div class="col-md-7 student-profile-review1"> 
                ...
                <div class="alert alert-warning alert-dismissible fade show fs-5" role="alert">
                    <i class="fa-solid fa-triangle-exclamation"></i> Application will not be processed until payment received. <a href="/student_profile_application"> View unpaid applications</a>
                                                        ...
                                                        <div class="css-k28thh">
                                                            ...
                                                            <div class="req-desc css-lsgy9k">
                                                                <div class="wrapped-content"> 
                                                                    ...
                                                                    <div class="css-see-more">
                                                                        <p>See More <span class="fa fa-caret-up"></span>  </p>
                                                                    </div>
...
<div class="modal fade" id="add_backup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Backup</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <h4><b>Select up to 3 Backup Programs in order of preferance.</b></h4>
                <h3>These programs will either be submitted under the same Application Fee for your selected program OR will be used in the event your primary choice is not avaliable.</h3>
                <p>Only programs that you are eligble for from the same school can be selected as Backup programs.</p>
                
                <div class="form-title">
                    <h4>Chhoose a program</h4>
                </div>
                
                <div class="form-field">
                    <div class="formn_row_list12">
                        <div class="count">
                            1.
                        </div>
                        <div class="select-dropdwon">
                            <select class="form-select" aria-label="Default select example">
                                <option selected>Backup Program 1</option>
                                <option value="1">CHESHIRE COLLEGE SOUUTH AND WEST-ELLESMERE PORT</option>
                                <option value="2">Education and Childcare Pre-T Level Transition Programme</option>
                                <option value="3">Health, Healthcare and Healthcare Science Pre-T Level Transition Programme</option>
                            </select>
                        </div>
                ...
                <div class="form-title-add-program">
                    <button>
                        <i class="fa-solid fa-plus"></i>
                        <p class="fs-4">Add New Program</p>
                    </button>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary">Save Backup(s)</button>
            </div>
        </div>
    </div>
</div>
