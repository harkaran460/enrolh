    ...
    <div class="panel">
        ...
        <div class="pBody">
            <div class="btnGroup m-0 justify-content-start">
                ...
                {{--<a href="#" class="btn btn-secondary" disabled="disabled">Upload Documents <?php if($studentdetails[0]->study_permit_visa !=0 ){ ?><i class="fa-solid fa-circle-check greenColor"></i><?php }else{?><i class="fa-solid fa-circle-check redColor"></i><?php }?></a>--}}
            </div>
