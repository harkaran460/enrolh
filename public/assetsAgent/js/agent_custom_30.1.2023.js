...
function agentStudentProfileUpdate() {
    ...
    let graduation_date = $("#graduation_date").val();
    ...
    if (first_name == "") {
        ...
        return false;
    } else if ($('input[name="marital_status"]:checked').length == 0) {
        $("#error").html(
            '<div class="alert alert-danger" role="alert">Please check marital status.</div>'
        );
       ...
       // $("input[name='marital_status']").focus();
        ...
        $("#grade_average").focus();
        return false;
    } else if (country_of_institution == 0) {
        $("#error").html(
            '<div class="alert alert-danger" role="alert">Please select country of institution.</div>'
        );
        $("#country_of_institution").focus();
        return false;
    } else if (name_of_institution == '') {
        $("#error").html(
            '<div class="alert alert-danger" role="alert">Please enter name of institution.</div>'
        );
        $("#name_of_institution").focus();
        return false;
    } else if (level_of_education == 0) {
        $("#error").html(
            '<div class="alert alert-danger" role="alert">Please select highest level of education.</div>'
        );
        $("#level_of_education").focus();
        return false;
