    ...
    if (stu_valid_arr.length == stu_val_count) {
        ...
        if ($('#' + runner).hasClass('d-none')) {
            ...
            if (!$('#' + division + '_selector').hasClass('active')) {
                ...
                $('#' + division + '_icon').removeClass('bg-success');
                $('#' + division + '_icon').addClass('bg-success');
                $('#' + division + '_text').removeClass('text-primary');
                $('#' + division + '_text').addClass('text-success');
            ...
            if ($('#' + runner + '_icon').hasClass('p-0-8rem')) {
                ...
                $('#' + runner + '_icon').addClass('bg-success');
...
var xValues = ["17 - 30 Years old", "31 - 50 Years old", "50 Years old"];
...
var xValues = ["17 - 30 Years old", "31 - 50 Years old", "50 Years old"];
var yValues = [100, 49, 44];
var backgroundColors = ["#1e3a8a", "#50a5f1", "#f1b44c"];
var hoverBackgroundColors = ["#1e3a8a", "#50a5f1", "#f1b44c"];
var borderColors = [
    "#1e3a8a",
    "#50a5f1",
    "#f1b44c"
...
for (let anchor of document.querySelectorAll("div.container__days a")) {
    anchor.innerHTML = "<span>" + anchor.innerText + "</span>"
};